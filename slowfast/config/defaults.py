...
# whether freeze the layer before STFM.
_C.MODEL.FINETUNNING = False
# -----------------------------------------------------------------------------
# MViT options
# -----------------------------------------------------------------------------
_C.MVIT = CfgNode()
...
# embedding dimension.
_C.UNIFORMER.EMBED_DIM = [64, 128, 320, 768]
...
_C.STFM.NUM_TOKENS = 64

_C.STFM.DENSE = True

_C.STFM.POS_KERNEL = 3

_C.STFM.SIMILAR_LOSS = False
...
_C.DATA.LABEL_PATH_TEMPLATE = "somesomev2_rgb_{}_split.txt"
